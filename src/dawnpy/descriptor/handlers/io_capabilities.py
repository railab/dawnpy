# tools/dawnpy/src/dawnpy/descriptor/handlers/io_capabilities.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Complete handler for the ``capabilities`` IO type (pass-through)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "capabilities"
cpp_class: str = "CIOCapabilities"
