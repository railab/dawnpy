# tools/dawnpy/src/dawnpy/descriptor/handlers/io_battery_volt.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Handler for the ``batt_volt`` IO type (no per-instance fields)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "batt_volt"
cpp_class: str = "CIOBattVolt"
