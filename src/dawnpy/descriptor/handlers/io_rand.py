# tools/dawnpy/src/dawnpy/descriptor/handlers/io_rand.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Complete handler for the ``rand`` IO type (no per-instance fields)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "rand"
cpp_class: str = "CIORand"
nuttx_requirements: tuple[str, ...] = ("CONFIG_DEV_URANDOM",)
no_fields: bool = True
