# tools/dawnpy/src/dawnpy/descriptor/handlers/io_dac.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Complete handler for the ``dac`` IO type (no per-instance fields)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "dac"
cpp_class: str = "CIODac"
nuttx_requirements: tuple[str, ...] = ("CONFIG_DAC",)
no_fields: bool = True
