"""Handler for ``statsmax`` PROG type."""
...
yaml_type: str = "statsmax"
cpp_class: str = "CProgStatsMax"


def config_fields() -> list[ConfigField]:
    """Return the user-facing YAML config schema for ``statsmax``."""
...
def encode_binary(
    ...
    """Append ``statsmax`` config items to ``items``."""
    del decoder
