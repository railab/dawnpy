# tools/dawnpy/src/dawnpy/descriptor/handlers/io_buttons.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Complete handler for the ``buttons`` IO type (no per-instance fields)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "buttons"
cpp_class: str = "CIOButtons"
nuttx_requirements: tuple[str, ...] = ("CONFIG_INPUT_BUTTONS",)
no_fields: bool = True
