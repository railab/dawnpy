# tools/dawnpy/src/dawnpy/descriptor/handlers/io_gpi.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Complete handler for the ``gpi`` IO type (no per-instance fields)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "gpi"
cpp_class: str = "CIOGpi"
nuttx_requirements: tuple[str, ...] = ("CONFIG_DEV_GPIO",)
no_fields: bool = True
