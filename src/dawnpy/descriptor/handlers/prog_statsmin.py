"""Handler for ``statsmin`` PROG type."""
...
yaml_type: str = "statsmin"
cpp_class: str = "CProgStatsMin"


def config_fields() -> list[ConfigField]:
    """Return the user-facing YAML config schema for ``statsmin``."""
...
def encode_binary(
    ...
    """Append ``statsmin`` config items to ``items``."""
    del decoder
