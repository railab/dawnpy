# tools/dawnpy/src/dawnpy/descriptor/handlers/io_battery_soc.py
#
# SPDX-License-Identifier: Apache-2.0
#

"""Handler for the ``batt_soc`` IO type (no per-instance fields)."""

from dawnpy.descriptor.definitions.type_info import ConfigField
from dawnpy.descriptor.encoding.io_serialization import _IOSerializeContext

yaml_type: str = "batt_soc"
cpp_class: str = "CIOBattSoc"
